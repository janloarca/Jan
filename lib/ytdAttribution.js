...
// Nombra la causa sin jerga interna; el detalle numérico va en `detail` para
// quien depura, no para la UI.
export function attributionRefusalText(reason, lang = 'es') {
  const es = {
