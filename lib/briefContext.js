 ...
 */
export async function loadUserPortfolioContext({ db, uid, prefs = {} }) {
  ...
  return { items: enriched, transactions, snapshots, augmented, netWorth, totalAssets, baseCurrency, convert }
}
