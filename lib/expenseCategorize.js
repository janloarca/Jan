...
export const MERCHANT_RULES = [
  { category: 'Alimentación', any: ['super', 'walmart', 'paiz', 'la torre', 'despensa', 'maxi', 'fresh market', 'carniceria', 'panaderia', 'mercado', 'grocery'] },
  { category: 'Alimentación', any: ['restaurante', 'restaurant', 'cafe', 'coffee', 'starbucks', 'mcdonald', 'burger', 'pizza', 'taco', 'sushi', 'pollo campero', 'campero', 'kfc', 'subway', 'wendy', 'domino', 'bar ', 'cerveceria', 'pub', 'cocina', 'comedor', 'deli', 'bakery'] },
  ...
  { category: 'Entretenimiento', any: ['cine', 'cinepolis', 'cinemark', 'padel', 'paddle', 'gimnasio', 'gym', 'smart fit', 'crossfit', 'yoga', 'club', 'golf', 'tenis', 'futbol', 'boliche', 'concierto', 'teatro', 'museo', 'hotel', 'resort', 'airbnb', 'booking', 'steam', 'playstation', 'xbox', 'nintendo'] },
