...
//       · Re-base final por (anchorVal / (firstVal + fondeado)) para dividir
//         entre el costo total, no solo el fondeo nuevo. Con un solo activo
//         desde $0, firstVal es 0 y esto es exactamente anchorVal/funded de
//         antes. La escala NO toca el numerador, por la misma razón que (C).
