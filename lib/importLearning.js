...
//
// Una fila que el usuario ya puso en otra categoría no se pisa por corregir a
// una hermana: ahí la decisión más reciente sobre ESA fila es la suya, no una
// consecuencia. Eso lo lleva la fila misma (`_categorySetByUser`), no un
// registro aparte de clics; hubo un parámetro `touched` que decía hacer esto y
// el cuerpo nunca lo leía, o sea prometía una capacidad que no existía.
export function applyCategoryToMatchingRows(rows, index, category) {
