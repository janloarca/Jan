...
export function detectPhantomFlows(transactions = []) {
  ...
  for (const [source, group] of groups) {
    // Never touch anything the user entered themselves. TODO origen manual
    // lleva el prefijo "manual" (manual_new_account, manual_contribution,
    // manual_balance_flow, manual_cashflow...): la comparación exacta solo
    // cubría el fallback sin _source y dejaba juzgar los demás como si fueran
    // de un broker.
