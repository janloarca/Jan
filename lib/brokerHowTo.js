  ...
  ibkr: {
    ...
    csv: {
      steps: [
        ...
        { es: 'Creá un Activity Flex Query con 5 secciones', en: 'Create an Activity Flex Query with 5 sections',
          detail: { es: 'Open Positions, Trades, Cash Transactions, Cash Report y Net Asset Value (NAV) in Base. La sección NAV trae el valor diario de tu cuenta: sin ella el historial y el % de retorno arrancan en blanco (en portales antiguos aparece como "Equity Summary by Report Date in Base", es la misma sección). Cash Report trae tu efectivo: sin ella no aparece en el portafolio. Dentro de "Cash Transactions", marca el tipo "Deposits & Withdrawals" (o "Select All"): sin esos movimientos tus depósitos se cuentan como ganancia en los retornos.', en: 'Open Positions, Trades, Cash Transactions, Cash Report and Net Asset Value (NAV) in Base. The NAV section brings your daily account value: without it the history and the % return chart start blank (on older portals it shows as "Equity Summary by Report Date in Base", same section). Cash Report brings your cash: without it it never shows in the portfolio. Inside "Cash Transactions", tick the "Deposits & Withdrawals" type (or "Select All"): without those movements your deposits count as gains in your returns.' } },
    ...
    api: {
      steps: [
        { es: 'Andá a "Performance & Reports" → "Flex Queries"', en: 'Go to "Performance & Reports" → "Flex Queries"' },
        { es: 'Creá un Activity Flex Query con 5 secciones', en: 'Create an Activity Flex Query with 5 sections',
          detail: { es: 'Open Positions, Trades, Cash Transactions, Cash Report y Net Asset Value (NAV) in Base. La sección NAV trae el valor diario de tu cuenta (en portales antiguos aparece como "Equity Summary by Report Date in Base", es la misma sección). Cash Report trae tu efectivo: sin ella no aparece en el portafolio. Dentro de "Cash Transactions", marca el tipo "Deposits & Withdrawals" (o "Select All"): sin esos movimientos tus depósitos se cuentan como ganancia en los retornos.', en: 'Open Positions, Trades, Cash Transactions, Cash Report and Net Asset Value (NAV) in Base. The NAV section brings your daily account value (on older portals it shows as "Equity Summary by Report Date in Base", same section). Cash Report brings your cash: without it it never shows in the portfolio. Inside "Cash Transactions", tick the "Deposits & Withdrawals" type (or "Select All"): without those movements your deposits count as gains in your returns.' } },
        { es: 'Configurá "Open Positions" para traer lotes con fecha', en: 'Set "Open Positions" to bring dated lots',
