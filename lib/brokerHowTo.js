  ...
  ibkr: {
    ...
    csv: {
      steps: [
        ...
        { es: 'LO MÁS IMPORTANTE: en "Period" NO dejes "Daily". Elige "Year to Date" para este año, o "Annual" para años anteriores. Un estado de un solo día no trae ninguna compra ni historial', en: 'THE KEY STEP: under "Period" do NOT leave "Daily". Choose "Year to Date" for this year, or "Annual" for previous years. A single day statement has no purchases and no history at all' },
        { es: 'Si te deja elegir secciones, marca "Trades" (fechas de compra y venta) y "Net Asset Value (NAV)" (valor diario de la cuenta)', en: 'If it lets you choose sections, tick "Trades" (purchase and sale dates) and "Net Asset Value (NAV)" (daily account value)' },
        { es: 'Formato: CSV o Excel. Descarga el archivo y súbelo aquí', en: 'Format: CSV or Excel. Download the file and upload it here' },
        { es: 'IBKR limita cada estado a 365 días, y guarda hasta 5 años atrás. Si tienes varios años, descarga uno por año y súbelos uno por uno: se van sumando', en: 'IBKR caps each statement at 365 days and keeps up to 5 years back. If you have several years, download one per year and upload them one at a time: they add up' },
      ],
    ...
    api: {
      ...
      note: { es: 'Solo lectura: el token no puede operar ni mover dinero. El período gobierna cuántos trades y cuántos días de valor llegan, así que uno corto deja el gráfico estimando el pasado.', en: 'Read-only: the token cannot trade or move money. The period governs how many trades and how many value days arrive, so a short one leaves the chart estimating the past.' },
    },
  },
