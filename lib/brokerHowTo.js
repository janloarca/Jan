  ...
  ibkr: {
    ...
    csv: {
      steps: [
        ...
        { es: 'Elige el período (idealmente "Year to Date" o un rango que cubra todo lo que quieres importar)', en: 'Choose the period (ideally "Year to Date" or a range covering everything you want to import)' },
        { es: 'Formato: CSV o Excel. Incluye las secciones Open Positions, Trades y NAV', en: 'Format: CSV or Excel. Include the Open Positions, Trades and NAV sections' },
        { es: 'Descarga el archivo y súbelo aquí', en: 'Download the file and upload it here' },
      ],
      note: { es: 'Este es el "Activity Statement", distinto del Flex Query que usa la sincronización automática (API).', en: 'This is the "Activity Statement", different from the Flex Query used by automatic sync (API).' },
    },
    api: {
      steps: [
