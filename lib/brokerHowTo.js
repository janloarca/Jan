  ...
  ibkr: {
    ...
    csv: {
      steps: [
        ...
        { es: 'Para lo anterior a esos ~365 días, transcribilo una vez', en: 'For anything before those ~365 days, transcribe it once',
        ...
        { es: 'Copiá los retornos que IBKR te muestra hoy', en: 'Copy the returns IBKR shows you today',
