...
const ALLOW_TITLE = [
  {
    file: 'QuickAddRow.jsx',
    why: 'es una fila de captura SIEMPRE visible arriba de la lista, no una card de contenido con algo que titular: va en p-3 (más angosto que la generación vieja) y su contenido ES el formulario de un gasto, con Enter para guardar. Un título ahí competiría con la primera fila real de la lista, justo debajo',
  },
]
