...
// FASE OM: `debitFields` (lib/transferFields.js) sella `balanceAsOf` con
// `todayLocalISO()`, que depende del reloj real. Se fija con timers falsos
// para que las aserciones sobre `dest.fields` sean deterministas.
...
describe('saleReversalPlan', () => {
  ...
  it('el destino se ajusta por DELTA contra el saldo de HOY, no restaurando el de la venta', () => {
    ...
    expect(plan.dest.fields).toEqual({ currentPrice: 1100, purchasePrice: 1100, balanceAsOf: TODAY })
  })
