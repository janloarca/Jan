...
describe('recordatorio de fin de mes: contenido', () => {
  ...
  test('cualquier idioma desconocido cae a español (default de la app)', () => {
    const { html } = buildFinanceReminderEmail('pt', 'agosto 2026')
    expect(html).toContain('Llenar mis finanzas')
  })
