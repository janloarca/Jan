...
//
// ⛔ POR QUE ES UN GUARDIAN DE FUENTE Y NO UN TEST DE COMPORTAMIENTO. `jest`
// no fija `TZ` (no hay `globalSetup` ni `TZ=` en package.json), asi que con el
// runner en UTC `getFullYear()` y `getUTCFullYear()` devuelven lo MISMO y
// ningun test de valores puede notar la diferencia. Peor: el fixture de
