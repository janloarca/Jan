...
describe('pedir prestado no es invertir', () => {
  ...
  it('regresión negativa: sin la exclusión, el préstamo restaba 4,000 del invertido', () => {
    const sinExcluir = { type: 'WITHDRAWAL', date: '2026-08-25', totalAmount: 4000, currency: 'USD', _linkedItemId: 'd1', _source: 'otra_cosa' }
    const r = computeYtdInvested({ transactions: [sinExcluir], items: [DEUDA], year: 2026, baseCurrency: 'USD' })
    expect(r.invested).toBeCloseTo(-4000, 6)
  })
})
