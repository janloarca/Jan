...
import { planEquitySnapshotWrites, IBKR_NAV_DOC_SUFFIX } from '@/lib/ibkrSnapshotPlan'
...
describe('planEquitySnapshotWrites: donde aterriza cada NAV', () => {
  ...
  it('fecha ocupada por un backfill (reconstruccion): reemplazo plano en su lugar', () => {
    const existing = [{ id: '2026-06-10', date: '2026-06-10', netWorthUSD: 11000, _source: 'backfill' }]
