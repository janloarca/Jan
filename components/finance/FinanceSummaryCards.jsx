  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      <div className="bg-[#1C1C1E] border border-[#38383A] rounded-xl p-4">
        ...
        <p className="text-h2 font-mono tabular-nums" style={{ color: '#34d399' }}>Q{fmt(income)}</p>
      </div>
      <div className="bg-[#1C1C1E] border border-[#38383A] rounded-xl p-4">
        <p className="text-caption text-slate-500 mb-1">{t('Gastos', 'Expenses')}</p>
        <p className="text-h2 font-mono tabular-nums" style={{ color: '#f87171' }}>Q{fmt(expenses)}</p>
      </div>
      <div className="bg-[#1C1C1E] border border-[#38383A] rounded-xl p-4">
