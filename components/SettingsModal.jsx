...
export default function SettingsModal({ onClose, settings, onSaveSettings, onDeleteAllItems, onDeleteAllSnapshots, onDeleteAllTransactions, lang = 'es' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <div className="bg-[#131c2e] border border-[#1e2d45] rounded-xl shadow-2xl max-w-md w-full max-h-[85vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          ...
          {tab === 'data' && (
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={action.key} className="flex items-center justify-between p-3 bg-[#0b1120] border border-[#1e2d45] rounded-lg">
                  <div>
