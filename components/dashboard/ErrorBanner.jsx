...
export default function ErrorBanner({ pricesError, ratesError, lang }) {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2.5 bg-amber-500/10 border border-amber-500/20 rounded-xl text-amber-400">
      ...
      <button onClick={() => setDismissed(true)} className="text-amber-500/60 hover:text-amber-400 ml-2 p-1">
