  ...
  if (editing) {
    return (
      <input
        ...
        className="w-full bg-[#0d1117] border border-blue-500/50 rounded px-1.5 py-0.5 text-xs text-white text-right font-medium tabular-nums focus:outline-none focus:ring-1 focus:ring-blue-500/30"
      />
    )
  }
        ...
        <table className="w-full text-xs border-collapse min-w-[480px]">
          <thead>
            <tr className="border-b-2 border-[#475569]">
              <th className="text-left py-2 pr-2 text-slate-500 font-semibold sticky left-0 bg-[#161b22] z-10 min-w-[180px]">
          ...
          {groups.map((group) => {
            ...
            return (
              <tbody key={group.name}>
                <tr className="bg-[#0d1117]/60 cursor-pointer hover:bg-[#0d1117]/80 transition-colors"
                  onClick={() => toggleGroup(group.name)}>
                  <td className="py-2 pr-2 sticky left-0 bg-[#0d1117]/60 z-10">
                ...
                {!isCollapsed && group.items.map((item, i) => {
                  ...
                  return (
                    <tr key={item.id || i} className="border-b border-[#161b22] hover:bg-[#1c2129]/30 transition-colors">
                      <td className="py-1.5 pr-2 pl-7 sticky left-0 bg-[#161b22] z-10">
          ...
          <tfoot>
            <tr className="border-t-2 border-[#475569]">
              <td className="py-2.5 pr-2 sticky left-0 bg-[#161b22] z-10">
