    ...
    <div className="bg-[#161b22]/80 rounded-xl border border-[#21262d]/50 p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="flex bg-[#0d1117] rounded-lg border border-[#21262d]/50 overflow-hidden">
      ...
      {mode === 'montecarlo' && mcResult ? (
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="bg-[#0d1117] rounded-lg p-3 border border-[#21262d]/50 text-center">
      ...
      {mode === 'montecarlo' && mcResult?.goalProbability != null && goalValue > 0 && (
        <div className="mt-3 px-3 py-2 bg-[#0d1117] rounded-lg border border-[#21262d]/50 flex items-center gap-2">
