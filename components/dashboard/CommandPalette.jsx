...
export default function CommandPalette({ open, onClose, items, lang, onAction }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh] bg-black/60" onClick={onClose}>
      <div className="bg-[#1e293b] border border-[#334155] rounded-xl shadow-2xl w-full max-w-lg overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-4 py-2 border-t border-[#334155] flex items-center gap-4 text-[10px] text-slate-600">
