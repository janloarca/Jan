  ...
  return (
    <div className="bg-[#131c2e] rounded-xl border border-[#1e2d45] p-4">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-[9px] text-slate-600">S&P 500</span>
      </div>

      <div className="grid grid-cols-2 gap-3 mb-2">
        <div>
          <span className="text-[9px] text-slate-500 block">{t('Tu portafolio', 'Your portfolio')}</span>
        ...
        <div className="text-right">
          <span className="text-[9px] text-slate-500 block">S&P 500</span>
