...
export default function DocumentVault({ uid, itemId, lang }) {
  ...
  return (
    <div className="border-t border-[#21262d]/50 pt-4 mt-4">
      ...
      {loading ? (
        ...
        <div className="space-y-1.5">
          {docs.map((doc) => (
            <div key={doc.id} className="flex items-center gap-2 p-2 bg-[#0d1117] rounded-lg border border-[#21262d]/30 group">
