...
export default function NetWorthCard({ netWorth, returnYTD, ytdChange, returnSinceStart, sinceStartDate, yearlyChange, dailyChange, convert, lang, netContributions, cashTotal, snapshots }) {
  ...
  return (
    <div className="bg-gradient-to-br from-theme-card to-theme-surface rounded-2xl border border-glass-border p-6 card-hero">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={pickerRef}>
            <button onClick={() => setShowPicker(!showPicker)}
              className="text-xs px-2 py-0.5 rounded text-slate-500 hover:bg-slate-700 hover:text-slate-300 transition-colors cursor-pointer border border-transparent hover:border-glass-border">
              {displayCur}
            </button>
            {showPicker && (
              <div className="absolute right-0 top-full mt-1 bg-theme-card border border-glass-border rounded-lg shadow-xl z-10 p-1 min-w-[80px]">
