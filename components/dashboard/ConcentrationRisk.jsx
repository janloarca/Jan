  ...
  return (
    <div className="bg-[#131c2e] rounded-xl border border-[#1e2d45] p-5">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className={`text-[10px] font-medium px-2 py-1 rounded-full border ${levelLabel[displayHHI.level].color}`}>
      ...
      <div className="flex items-center gap-3 mb-3 px-2 py-1.5 bg-[#0b1120] rounded-lg border border-[#1e2d45]/50">
        ...
        <span className="text-[10px] font-bold text-slate-300">{displayHHI.hhi}</span>
      </div>
