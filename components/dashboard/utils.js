...
// Whether a period's anchor date is already covered by REAL broker data: the
// whole stretch from the first real datapoint onwards is measured by real
// data, so an anchor at/after that date has nothing to add. String compares
// only ('YYYY-MM-DD').
