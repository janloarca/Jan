    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {onIBKR && (
        <button onClick={onIBKR}
          className="px-4 py-2 text-xs font-medium bg-orange-600/20 border border-orange-500/30 text-orange-400 rounded-lg hover:bg-orange-600/30 transition-colors">
          IBKR Sync
        </button>
      )}
