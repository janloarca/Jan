    ...
    <div className="bg-[#161b22]/80 rounded-xl border border-[#21262d]/50 p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          {!editing && (
            <span className="text-xs text-slate-500 bg-[#0d1117] px-2 py-0.5 rounded">
      ...
      {editing ? (
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-500 bg-[#0d1117] px-1.5 py-0.5 rounded">{formatCompact(incomeGoal)}/{t('año', 'yr')}</span>
              </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-500 bg-[#0d1117] px-1.5 py-0.5 rounded">{formatCompact(portfolioGoal)}</span>
              </div>
          ...
          {goalProbability != null && (
            <div className="flex items-center gap-3 px-3 py-2 bg-[#0d1117] rounded-lg border border-[#21262d]/50">
