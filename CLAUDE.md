...
- [ ] FASE GM parte 2 (pendiente): simplificar visualmente las instrucciones largas DENTRO de los pasos del viaje IBKR según lo aprobado por el usuario: cada paso muestra UNA línea de acción + botón "i" expandible con el detalle (nada de paredes de 7 instrucciones, "es muy agobiante"). Hacerlo bonito. Los otros 21 brokers heredan el patrón después. La parte 1 (orquestador continuo de 5 pasos) quedó en FASE GM.
