...
- [ ] Plan IBKR interconectado, fases restantes: Fase 2b (leer altura de barras de Cash Flows de la foto para monto aproximado por trimestre; probar si los Activity Statements ANUALES de IBKR alcanzan años viejos, lo que daría datos EXACTOS pre-365d sin inferencia), Fase 3 (inferencia restringida globalmente: Σ inferidos = Net D&W de por vida del resumen persistido − flujos exactos de la ventana, repartidos por trimestres con marcador D/W, aprobación vía InferredFlowsModal ya existente), Fase 4 (tablero de conciliación contra PortfolioAnalyst). Fase 1 y 2a hechas en FASE GI.
