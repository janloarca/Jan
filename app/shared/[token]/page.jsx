...
function SharedDashboard({ items, snapshots, baseCurrency }) {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117]">
      <header className="border-b border-[#21262d] bg-[#161b22]/80 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => {
              ...
              className="px-2 py-1 text-xs text-slate-500 border border-[#21262d] rounded hover:bg-[#1c2129] transition-colors">
              CSV
            </button>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        {/* Net Worth */}
        <div className="bg-[#161b22]/80 rounded-xl border border-[#21262d]/50 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Asset Allocation */}
          <div className="bg-[#161b22]/80 rounded-xl border border-[#21262d]/50 p-5">
            ...
            <div className="mt-4 pt-3 border-t border-[#21262d]/30 text-xs text-slate-500">
