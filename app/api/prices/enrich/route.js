...
export async function POST(request) {
  ...
  if (!Array.isArray(symbols) || symbols.length === 0) {
    return NextResponse.json({ error: 'symbols array required', errorCode: 'BAD_REQUEST' }, { status: 400 })
  }
  ...
  try {
    ...
    return NextResponse.json({ error: 'Internal server error', errorCode: 'INTERNAL', results: {} }, { status: 500 })
  }
}
