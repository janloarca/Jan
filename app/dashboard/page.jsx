...
export default function DashboardPage() {
  ...
  const {
    ...
    returnYTD, ytdChange, ytdStartValue, ytdStartTs, ytdStartSrc, ytdCalIgnored, returnSinceStart, sinceStartDate, ytdCalibrated, ytdBreakdown, ytdBreakdownReason, ytdBreakdownDetail, ytdBreakdownTerms,
    ...
    <div className="min-h-screen bg-theme-base">
        ...
        <div className="stagger-1 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 items-stretch">
          <div className="md:col-span-1 lg:col-span-2 flex flex-col gap-4">
            ...
            <NetWorthCard
              ...
              ytdStartValue={ytdStartValue} ytdStartTs={ytdStartTs} ytdStartSrc={ytdStartSrc} ytdCalIgnored={ytdCalIgnored}
      ...
      {modalShown === 'ibkr' && (
        <IBKRSyncModal
          ...
          onSaveCredentialsPending={(creds) => { saveSettings({ ...creds, _ibkrConnectedAt: new Date().toISOString(), _ibkrAutoSyncStatus: null, _ibkrAutoSyncError: null, _ibkrAutoSyncErrorCode: null, _ibkrAutoSyncFailCount: 0, _ibkrAttemptsToday: null, _ibkrLastUpstreamError: null }) }}
      ...
      {modalShown === 'connections' && (
        <ConnectionsModal
          ...
          ibkrUpstreamError={ibkrUpstreamError}
          ibkrSkipReason={ibkrSkipReason}
          ...
          onSaveCredentials={(creds) => { saveSettings({ ...creds, _ibkrAutoSyncStatus: null, _ibkrAutoSyncError: null, _ibkrAutoSyncErrorCode: null, _ibkrAutoSyncFailCount: 0, _ibkrAttemptsToday: null, _ibkrLastUpstreamError: null }) }}
